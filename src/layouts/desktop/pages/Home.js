      ...
      <div id='about'>
        <div className='about-desktop-extra'>
          ...
          <p className='about-desktop-extra-info'>
            ...
            tech rabbit hole on a topic that I enjoy. I have loved everything
            about what I've learn so far and I am passionate about making web
            apps and especially making them look good while I'm at it.
          </p>
        </div>
      </div>
    </div>
